...
from qbox.models import Question, Answer, Tag, AnswerComment, QuestionComment, \
...
class QuestionDetailView(django_views.ListView):  # used to be ListView
    template_name = 'qbox/question.html'
    model = Answer
    ...
    def post(self, *args, **kwargs):
        ...
        return redirect("/qbox/q/"+str(self.question.id))


class AskQuestionView(django_views.edit.CreateView):  # or FormView
    model = Question
    template_name = "qbox/ask.html"
    fields = ["title", "text"]
...
class AddTagView(django_views.edit.CreateView):  # or FormView
    ...
    question = None
    # query_string = True
    template_name = "qbox/edit_question.html"
    fields = ["text"]
    success_url = 'add_tag'
